...
- Add `useRootVolume` option on bastion, control plane, and worker machine definitions to explicitly use non-ephemeral volumes.
...
[Unreleased]: https://github.com/giantswarm/cluster-openstack/compare/v0.5.0...HEAD
